...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey('products.ProductWashing', on_delete=models.CASCADE, related_name='order_items')
    product = models.ForeignKey('products.ProductCooking', on_delete=models.CASCADE, related_name='order_items')
    product = models.ForeignKey('products.ProductLaptop', on_delete=models.CASCADE, related_name='order_items')
    product = models.ForeignKey('products.ProductHeadphone', on_delete=models.CASCADE, related_name='order_items')
    product = models.ForeignKey('products.ProductOffice', on_delete=models.CASCADE, related_name='order_items')
